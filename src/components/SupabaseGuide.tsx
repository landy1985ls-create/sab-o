...
-- SE A SUA TABELA JÁ EXISTA, ESTE BLOCO GARANTE QUE AS NOVAS COLUNAS SEJAM CRIADAS INSTANTANEAMENTE:
ALTER TABLE clientes_consultas ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'Pendente';
ALTER TABLE clientes_consultas ADD COLUMN IF NOT EXISTS client_id UUID;
ALTER TABLE clientes_consultas ADD COLUMN IF NOT EXISTS agree_to_terms BOOLEAN DEFAULT TRUE;
